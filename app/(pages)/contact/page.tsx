  ...
  return (
    <div className="bg-slate-950 text-slate-50">
      <section className="relative overflow-hidden px-6 py-24">
        ...
        <div className="relative mx-auto grid w-full max-w-6xl gap-12 lg:grid-cols-[minmax(0,0.6fr)_minmax(0,1fr)]">
          <div className="space-y-6">
            <span className="inline-flex items-center gap-2 rounded-full border border-white/15 px-4 py-2 text-xs uppercase tracking-[0.4em] text-cyan-200/80">
              Let’s build together
            </span>
            <h1 className="font-aeonik text-4xl font-medium leading-tight text-white md:text-5xl">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="rounded-2xl border border-white/10 bg-slate-900/55 px-4 py-5 text-center">
              ...
              <div className="rounded-2xl border border-white/10 bg-slate-900/55 px-4 py-5 text-center">
                <p className="text-3xl font-semibold text-white">24/5</p>
            ...
            <div className="space-y-4">
              {contactOptions.map((option) => (
                <div
                  key={option.title}
                  className="flex flex-col gap-4 rounded-3xl border border-white/10 bg-slate-900/55 p-5 transition hover:border-white/20 hover:bg-slate-900/65 sm:flex-row sm:items-center sm:justify-between"
                >
                  <div className="flex items-start gap-4">
                    <span className="flex h-10 w-10 items-center justify-center rounded-2xl border border-white/20 bg-slate-950/70 text-cyan-200">
                  ...
                  <button className="inline-flex items-center gap-2 rounded-full border border-white/20 px-4 py-2 text-sm font-medium text-white transition hover:border-white">
                    {option.action}
                  </button>
                </div>
              ))}
          ...
          <div className="rounded-3xl border border-white/10 bg-slate-900/45 p-6 shadow-[0_30px_70px_rgba(8,47,73,0.45)]">
            <div className="space-y-6">
              <div className="space-y-2 text-left">
                <h2 className="text-xl font-semibold text-white">Start a project outline</h2>
              ...
              <form className="space-y-4">
                <div className="grid gap-4 sm:grid-cols-2">
                  <label className="space-y-2 text-sm">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-white/10 bg-slate-950/70 px-4 py-3 text-sm text-white placeholder:text-slate-500 focus:border-cyan-300 focus:outline-none"
                    />
                  </label>
                  <label className="space-y-2 text-sm">
                ...
                <div className="grid gap-4 sm:grid-cols-[1fr_auto]">
                  <label className="space-y-2 text-sm">
                    ...
                    <select className="w-full rounded-xl border border-white/10 bg-slate-950/70 px-4 py-3 text-sm text-white focus:border-cyan-300 focus:outline-none">
                  ...
                  <button
                    type="submit"
                    className="mt-6 inline-flex items-center justify-center gap-2 rounded-xl bg-white px-5 py-3 text-sm font-medium text-slate-950 transition hover:bg-slate-200"
                  >
      ...
      <section className="bg-slate-900/35 px-6 py-24">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-10">
          <div className="space-y-3 text-center">
            <span className="text-xs uppercase tracking-[0.4em] text-cyan-200/75">Where we operate</span>
            <h2 className="text-3xl font-medium text-white md:text-4xl">Global footprint, same operating rhythm</h2>
          ...
          <div className="flex flex-col gap-6 lg:flex-row">
            <div className="flex-1 space-y-4">
              {officeLocations.map((office) => (
                <div key={office.city} className="flex items-center justify-between rounded-3xl border border-white/10 bg-slate-950/60 p-5">
                  <div>
                    <h3 className="text-lg font-semibold text-white">{office.city}</h3>
                    <p className="text-sm text-slate-300/80">{office.address}</p>
                  </div>
                  <div className="text-xs uppercase tracking-[0.3em] text-cyan-200/75">{office.timezone}</div>
                </div>
              ))}
            </div>
            <div className="flex h-72 flex-1 items-center justify-center rounded-3xl border border-dashed border-white/20 bg-slate-900/45 text-xs uppercase tracking-[0.4em] text-slate-500">
      ...
      <section className="px-6 py-20">
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center gap-6 rounded-3xl border border-white/10 bg-slate-900/45 px-8 py-10 text-center">
          <h2 className="text-3xl font-medium text-white md:text-4xl">Ready when you are</h2>
          ...
          <button className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-medium text-slate-950 transition hover:bg-slate-200">
