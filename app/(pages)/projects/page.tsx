...
export default function Projects() {
  return (
    <div className="bg-slate-950 text-slate-50">
        ...
        <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-12 lg:flex-row">
          <div className="space-y-6 lg:w-3/5">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button className="inline-flex items-center gap-2 rounded-full border border-white/20 px-5 py-3 text-sm font-medium text-white transition hover:border-white hover:bg-white/5">
                Watch a case study <PlayCircle className="h-5 w-5" />
              </button>
            </div>
          </div>
          <div className="flex-1 space-y-5">
            <div className="flex h-[220px] items-center justify-center rounded-3xl border border-dashed border-white/20 bg-slate-900/40 text-xs uppercase tracking-[0.45em] text-slate-500">
              Case study reel placeholder
            </div>
            <div className="grid gap-4 md:grid-cols-2">
              {capabilities.map((capability) => (
                <div key={capability.title} className="rounded-3xl border border-white/10 bg-slate-900/55 p-5">
                  ...
                  <h3 className="mt-3 text-base font-semibold text-white">{capability.title}</h3>
        ...
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-10">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {caseStudies.map((study) => (
              <article key={study.title} className="group relative overflow-hidden rounded-3xl border border-white/10 bg-slate-900/55 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_24px_65px_rgba(8,47,73,0.45)]">
                ...
                <div className="relative space-y-4">
                  <span className="inline-flex items-center rounded-full border border-white/15 px-3 py-1 text-[10px] uppercase tracking-[0.45em] text-cyan-200/80">
                    {study.tag}
                  </span>
                  ...
                  <div className="flex h-32 items-center justify-center rounded-2xl border border-dashed border-white/15 bg-slate-950/60 text-[11px] uppercase tracking-[0.4em] text-slate-500">
                    Imagery placeholder
                  </div>
      ...
      <section className="bg-slate-900/35 px-6 py-24">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-12">
          <div className="space-y-3 text-center">
            ...
            <h2 className="text-3xl font-medium text-white md:text-4xl">Partners on the other side of launch day</h2>
          </div>
          <div className="grid gap-6 md:grid-cols-2">
            {testimonials.map((testimonial) => (
              <blockquote key={testimonial.person} className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-950/55 p-6 text-left">
      ...
      <section className="px-6 py-24">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 rounded-3xl border border-white/10 bg-slate-900/45 px-8 py-10 text-center shadow-[0_30px_70px_rgba(8,47,73,0.45)]">
          <h2 className="text-3xl font-medium text-white md:text-4xl">Planning a high-stakes release?</h2>
