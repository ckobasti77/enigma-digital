...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="mx-auto grid w-full grid-cols-[minmax(0,1fr)_auto] items-center lg:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)]"
          style={{
            paddingBottom: "1rem",
            paddingLeft:
              "max(var(--site-edge-gutter), env(safe-area-inset-left))",
            paddingRight:
              "max(var(--site-edge-gutter), env(safe-area-inset-right))",
